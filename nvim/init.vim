...
let g:UltiSnipsSnippetDirectory = ['C:\Users\jackwill\.config\nvim']
...
require'nvim-treesitter.configs'.setup {
  ...
  ensure_installed = { "c", "lua", "vim", "help","javascript","rust","python"},
...
autocmd FileType python vnoremap <buffer> <F2> :s/^/#<CR>
autocmd FileType rust vnoremap <buffer> <F2> :s/^///<CR>
